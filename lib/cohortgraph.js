...
var _initialiseProps = function _initialiseProps() {
    ...
    this._buildHeaders = function () {
        var _loop3 = function _loop3(key) {
            if (_this.store.hasOwnProperty(key)) {
                ...
                cellData.index = 0;
                cellData.type = key;
                cellData[VALUE] = _this._averageOfColumnWithIndex(_this.store[key], 1);
                ...
                largeRow.forEach(function (el, index) {
                    ...
                    if (index < 2) return;
                    var value = _this._averageOfColumnWithIndex(_this.store[key], index);
                    var percent = _this._getPercentage(_this._averageOfColumnWithIndex(_this.store[key], 1), value);
    ...
    this._averageOfColumnWithIndex = function (arr, index) {
        var avg = 0;
        var sum = 0;
        var totalCount = 0;
        arr.forEach(function (el) {
    ...
    this._shadeCellWithColor = function (percent) {
        var color = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "#5773E1";
